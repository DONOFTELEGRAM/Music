...
class MakeButtons:
    ...
    def source_markup(self):
        buttons = [
            [
                self.ikb(text="Github ❤️", url="https//t.me/AndreaSupport_Chat"),
                self.ikb(text="Private Repo", url="https://t.me/AndreaSupport_chat"),
            ],
            [
                self.ikb(text="Andrea { 🇮🇳 }", url="https://t.me/AndreaSupport_chat"),
            ],
            [
                self.ikb(text="Support 🎙️", url="https://t.me/AndreaSupport_Chat"),
                self.ikb(text="Updates 📣", url="https://t.me/AndreaUpdates"),
            ],
            [
